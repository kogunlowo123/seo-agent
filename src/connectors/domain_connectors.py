"""SEO Agent - Domain-Specific Connectors."""
...
class HubspotMarketingConnector:
    """Domain-specific connector for hubspot marketing integration with SEO Agent."""
...
class MarketoConnector:
    """Domain-specific connector for marketo integration with SEO Agent."""
...
class MailchimpConnector:
    """Domain-specific connector for mailchimp integration with SEO Agent."""
...
class GoogleAnalyticsConnector:
    """Domain-specific connector for google analytics integration with SEO Agent."""
...
class MetaAdsConnector:
    """Domain-specific connector for meta ads integration with SEO Agent."""
