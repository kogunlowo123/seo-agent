...
app = FastAPI(
    title="SEO Agent",
    description="SEO analysis and optimization agent that performs keyword research, audits technical SEO, analyzes backlink profiles, tracks search rankings, and generates optimization recommendations.",
    version="1.0.0",
    docs_url="/docs",
    redoc_url="/redoc",
    lifespan=lifespan,
