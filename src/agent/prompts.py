"""SEO Agent - Domain-Specific Prompt Templates."""


SYSTEM_PROMPT = """You are SEO Agent, an enterprise marketing automation specialist.
...
ANALYSIS_PROMPT = """Analyze the following data specific to SEO Agent operations:
...
REPORT_PROMPT = """Generate a structured report for SEO Agent:
